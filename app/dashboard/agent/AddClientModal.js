...
import { UserPlus, Mail, X, AlertCircle, CheckCircle } from 'lucide-react'
        ...
        <div className="flex items-center justify-between p-6 border-b border-[#344a57]/20">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[#8fa1ad] text-xs">Connect a homeowner by email</p>
            </div>
          </div>
        ...
        <div className="p-6">
          ...
          {success && (
            <div className="flex items-center gap-2 bg-green-900/20 border border-green-500/30 text-green-400 rounded-xl p-3 mb-4 text-sm">
              <CheckCircle className="w-4 h-4 flex-shrink-0" />Connected to {success}!
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-[#0f1623] border border-[#344a57]/40 rounded-lg text-white placeholder-[#464d4f] focus:outline-none focus:border-[#c9a84c] transition-colors text-sm"
                />
              </div>
              <p className="text-[#464d4f] text-xs mt-2">The homeowner must already have an account with that email.</p>
            </div>
            ...
            <div className="flex gap-3 pt-2">
              ...
              <button type="submit" disabled={loading || !!success}
                ...
                {loading ? 'Searching...' : 'Connect Client'}
              </button>
            </div>
          </form>
        </div>
